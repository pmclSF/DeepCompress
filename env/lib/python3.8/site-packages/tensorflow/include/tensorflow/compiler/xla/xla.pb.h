...
class ProfiledInstructionsProto_Instruction;
struct ProfiledInstructionsProto_InstructionDefaultTypeInternal;
extern ProfiledInstructionsProto_InstructionDefaultTypeInternal _ProfiledInstructionsProto_Instruction_default_instance_;
...
template<> ::xla::ProfiledInstructionsProto* Arena::CreateMaybeMessage<::xla::ProfiledInstructionsProto>(Arena*);
template<> ::xla::ProfiledInstructionsProto_Instruction* Arena::CreateMaybeMessage<::xla::ProfiledInstructionsProto_Instruction>(Arena*);
...
class DebugOptions final :
 ...
 public:
  ...
  enum : int {
    ...
    kXlaGpuCudaGraphLevelFieldNumber = 194,
    kXlaGpuCudaGraphInstantiationThresholdFieldNumber = 202,
    kXlaGpuCollectiveInflationFactorFieldNumber = 205,
    kXlaCpuSparseCudaThreadsFieldNumber = 207,
    kXlaGpuCudaGraphCaptureThresholdFieldNumber = 208,
  };
  ...
  void clear_xla_gpu_cuda_graph_level();
  int32_t xla_gpu_cuda_graph_level() const;
  void set_xla_gpu_cuda_graph_level(int32_t value);
  private:
  int32_t _internal_xla_gpu_cuda_graph_level() const;
  void _internal_set_xla_gpu_cuda_graph_level(int32_t value);
  public:

  // int32 xla_gpu_cuda_graph_instantiation_threshold = 202;
  void clear_xla_gpu_cuda_graph_instantiation_threshold();
  int32_t xla_gpu_cuda_graph_instantiation_threshold() const;
  void set_xla_gpu_cuda_graph_instantiation_threshold(int32_t value);
  private:
  int32_t _internal_xla_gpu_cuda_graph_instantiation_threshold() const;
  void _internal_set_xla_gpu_cuda_graph_instantiation_threshold(int32_t value);
  public:
  ...
  void clear_xla_gpu_cuda_graph_capture_threshold();
  int32_t xla_gpu_cuda_graph_capture_threshold() const;
  void set_xla_gpu_cuda_graph_capture_threshold(int32_t value);
  private:
  int32_t _internal_xla_gpu_cuda_graph_capture_threshold() const;
  void _internal_set_xla_gpu_cuda_graph_capture_threshold(int32_t value);
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    int32_t xla_gpu_cuda_graph_level_;
    int32_t xla_gpu_cuda_graph_instantiation_threshold_;
    int32_t xla_gpu_collective_inflation_factor_;
    int32_t xla_cpu_sparse_cuda_threads_;
    int32_t xla_gpu_cuda_graph_capture_threshold_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_tensorflow_2fcompiler_2fxla_2fxla_2eproto;
...
class ProfiledInstructionsProto_Instruction final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:xla.ProfiledInstructionsProto.Instruction) */ {
 public:
  inline ProfiledInstructionsProto_Instruction() : ProfiledInstructionsProto_Instruction(nullptr) {}
  ~ProfiledInstructionsProto_Instruction() override;
  explicit PROTOBUF_CONSTEXPR ProfiledInstructionsProto_Instruction(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  ProfiledInstructionsProto_Instruction(const ProfiledInstructionsProto_Instruction& from);
  ProfiledInstructionsProto_Instruction(ProfiledInstructionsProto_Instruction&& from) noexcept
    : ProfiledInstructionsProto_Instruction() {
    *this = ::std::move(from);
  }

  inline ProfiledInstructionsProto_Instruction& operator=(const ProfiledInstructionsProto_Instruction& from) {
    CopyFrom(from);
    return *this;
  }
  inline ProfiledInstructionsProto_Instruction& operator=(ProfiledInstructionsProto_Instruction&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const ProfiledInstructionsProto_Instruction& default_instance() {
    return *internal_default_instance();
  }
  static inline const ProfiledInstructionsProto_Instruction* internal_default_instance() {
    return reinterpret_cast<const ProfiledInstructionsProto_Instruction*>(
               &_ProfiledInstructionsProto_Instruction_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    51;

  friend void swap(ProfiledInstructionsProto_Instruction& a, ProfiledInstructionsProto_Instruction& b) {
    a.Swap(&b);
  }
  inline void Swap(ProfiledInstructionsProto_Instruction* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(ProfiledInstructionsProto_Instruction* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  ProfiledInstructionsProto_Instruction* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<ProfiledInstructionsProto_Instruction>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const ProfiledInstructionsProto_Instruction& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const ProfiledInstructionsProto_Instruction& from) {
    ProfiledInstructionsProto_Instruction::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(ProfiledInstructionsProto_Instruction* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "xla.ProfiledInstructionsProto.Instruction";
  }
  protected:
  explicit ProfiledInstructionsProto_Instruction(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  private:
  double _internal_timestamp_us() const;
  void _internal_set_timestamp_us(double value);
  public:
  ...
  // @@protoc_insertion_point(class_scope:xla.ProfiledInstructionsProto.Instruction)
 private:
  class _Internal;
...
class ProfiledInstructionsProto final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:xla.ProfiledInstructionsProto) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "xla.ProfiledInstructionsProto";
  }
  protected:
  ...
  typedef ProfiledInstructionsProto_Instruction Instruction;
  ...
  // repeated .xla.ProfiledInstructionsProto.Instruction instructions = 1;
  int instructions_size() const;
  private:
  int _internal_instructions_size() const;
  public:
  void clear_instructions();
  ::xla::ProfiledInstructionsProto_Instruction* mutable_instructions(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::ProfiledInstructionsProto_Instruction >*
      mutable_instructions();
  private:
  const ::xla::ProfiledInstructionsProto_Instruction& _internal_instructions(int index) const;
  ::xla::ProfiledInstructionsProto_Instruction* _internal_add_instructions();
  public:
  const ::xla::ProfiledInstructionsProto_Instruction& instructions(int index) const;
  ::xla::ProfiledInstructionsProto_Instruction* add_instructions();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::ProfiledInstructionsProto_Instruction >&
      instructions() const;

  // @@protoc_insertion_point(class_scope:xla.ProfiledInstructionsProto)
 private:
  class _Internal;
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::ProfiledInstructionsProto_Instruction > instructions_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_tensorflow_2fcompiler_2fxla_2fxla_2eproto;
...
// int32 xla_gpu_cuda_graph_level = 194;
inline void DebugOptions::clear_xla_gpu_cuda_graph_level() {
  _impl_.xla_gpu_cuda_graph_level_ = 0;
}
inline int32_t DebugOptions::_internal_xla_gpu_cuda_graph_level() const {
  return _impl_.xla_gpu_cuda_graph_level_;
}
inline int32_t DebugOptions::xla_gpu_cuda_graph_level() const {
  // @@protoc_insertion_point(field_get:xla.DebugOptions.xla_gpu_cuda_graph_level)
  return _internal_xla_gpu_cuda_graph_level();
}
inline void DebugOptions::_internal_set_xla_gpu_cuda_graph_level(int32_t value) {
  
  _impl_.xla_gpu_cuda_graph_level_ = value;
}
inline void DebugOptions::set_xla_gpu_cuda_graph_level(int32_t value) {
  _internal_set_xla_gpu_cuda_graph_level(value);
  // @@protoc_insertion_point(field_set:xla.DebugOptions.xla_gpu_cuda_graph_level)
}

// int32 xla_gpu_cuda_graph_instantiation_threshold = 202;
inline void DebugOptions::clear_xla_gpu_cuda_graph_instantiation_threshold() {
  _impl_.xla_gpu_cuda_graph_instantiation_threshold_ = 0;
}
inline int32_t DebugOptions::_internal_xla_gpu_cuda_graph_instantiation_threshold() const {
  return _impl_.xla_gpu_cuda_graph_instantiation_threshold_;
}
inline int32_t DebugOptions::xla_gpu_cuda_graph_instantiation_threshold() const {
  // @@protoc_insertion_point(field_get:xla.DebugOptions.xla_gpu_cuda_graph_instantiation_threshold)
  return _internal_xla_gpu_cuda_graph_instantiation_threshold();
}
inline void DebugOptions::_internal_set_xla_gpu_cuda_graph_instantiation_threshold(int32_t value) {
  
  _impl_.xla_gpu_cuda_graph_instantiation_threshold_ = value;
}
inline void DebugOptions::set_xla_gpu_cuda_graph_instantiation_threshold(int32_t value) {
  _internal_set_xla_gpu_cuda_graph_instantiation_threshold(value);
  // @@protoc_insertion_point(field_set:xla.DebugOptions.xla_gpu_cuda_graph_instantiation_threshold)
}

// int32 xla_gpu_cuda_graph_capture_threshold = 208;
inline void DebugOptions::clear_xla_gpu_cuda_graph_capture_threshold() {
  _impl_.xla_gpu_cuda_graph_capture_threshold_ = 0;
}
inline int32_t DebugOptions::_internal_xla_gpu_cuda_graph_capture_threshold() const {
  return _impl_.xla_gpu_cuda_graph_capture_threshold_;
}
inline int32_t DebugOptions::xla_gpu_cuda_graph_capture_threshold() const {
  // @@protoc_insertion_point(field_get:xla.DebugOptions.xla_gpu_cuda_graph_capture_threshold)
  return _internal_xla_gpu_cuda_graph_capture_threshold();
}
inline void DebugOptions::_internal_set_xla_gpu_cuda_graph_capture_threshold(int32_t value) {
  
  _impl_.xla_gpu_cuda_graph_capture_threshold_ = value;
}
inline void DebugOptions::set_xla_gpu_cuda_graph_capture_threshold(int32_t value) {
  _internal_set_xla_gpu_cuda_graph_capture_threshold(value);
  // @@protoc_insertion_point(field_set:xla.DebugOptions.xla_gpu_cuda_graph_capture_threshold)
}
...
// string name = 1;
inline void ProfiledInstructionsProto_Instruction::clear_name() {
  _impl_.name_.ClearToEmpty();
}
inline const std::string& ProfiledInstructionsProto_Instruction::name() const {
  // @@protoc_insertion_point(field_get:xla.ProfiledInstructionsProto.Instruction.name)
  return _internal_name();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ProfiledInstructionsProto_Instruction::set_name(ArgT0&& arg0, ArgT... args) {
 
 _impl_.name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:xla.ProfiledInstructionsProto.Instruction.name)
}
inline std::string* ProfiledInstructionsProto_Instruction::mutable_name() {
  std::string* _s = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:xla.ProfiledInstructionsProto.Instruction.name)
  return _s;
}
inline const std::string& ProfiledInstructionsProto_Instruction::_internal_name() const {
  return _impl_.name_.Get();
}
inline void ProfiledInstructionsProto_Instruction::_internal_set_name(const std::string& value) {
  
  _impl_.name_.Set(value, GetArenaForAllocation());
}
inline std::string* ProfiledInstructionsProto_Instruction::_internal_mutable_name() {
  
  return _impl_.name_.Mutable(GetArenaForAllocation());
}
inline std::string* ProfiledInstructionsProto_Instruction::release_name() {
  // @@protoc_insertion_point(field_release:xla.ProfiledInstructionsProto.Instruction.name)
  return _impl_.name_.Release();
}
inline void ProfiledInstructionsProto_Instruction::set_allocated_name(std::string* name) {
  if (name != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:xla.ProfiledInstructionsProto.Instruction.name)
}

// double timestamp_us = 2;
inline void ProfiledInstructionsProto_Instruction::clear_timestamp_us() {
  _impl_.timestamp_us_ = 0;
}
inline double ProfiledInstructionsProto_Instruction::_internal_timestamp_us() const {
  return _impl_.timestamp_us_;
}
inline double ProfiledInstructionsProto_Instruction::timestamp_us() const {
  // @@protoc_insertion_point(field_get:xla.ProfiledInstructionsProto.Instruction.timestamp_us)
  return _internal_timestamp_us();
}
inline void ProfiledInstructionsProto_Instruction::_internal_set_timestamp_us(double value) {
  
  _impl_.timestamp_us_ = value;
}
inline void ProfiledInstructionsProto_Instruction::set_timestamp_us(double value) {
  _internal_set_timestamp_us(value);
  // @@protoc_insertion_point(field_set:xla.ProfiledInstructionsProto.Instruction.timestamp_us)
}

// double duration_us = 3;
inline void ProfiledInstructionsProto_Instruction::clear_duration_us() {
  _impl_.duration_us_ = 0;
}
inline double ProfiledInstructionsProto_Instruction::_internal_duration_us() const {
  return _impl_.duration_us_;
}
inline double ProfiledInstructionsProto_Instruction::duration_us() const {
  // @@protoc_insertion_point(field_get:xla.ProfiledInstructionsProto.Instruction.duration_us)
  return _internal_duration_us();
}
inline void ProfiledInstructionsProto_Instruction::_internal_set_duration_us(double value) {
  
  _impl_.duration_us_ = value;
}
inline void ProfiledInstructionsProto_Instruction::set_duration_us(double value) {
  _internal_set_duration_us(value);
  // @@protoc_insertion_point(field_set:xla.ProfiledInstructionsProto.Instruction.duration_us)
}
...
// repeated .xla.ProfiledInstructionsProto.Instruction instructions = 1;
inline int ProfiledInstructionsProto::_internal_instructions_size() const {
  return _impl_.instructions_.size();
}
inline int ProfiledInstructionsProto::instructions_size() const {
  return _internal_instructions_size();
}
inline void ProfiledInstructionsProto::clear_instructions() {
  _impl_.instructions_.Clear();
}
inline ::xla::ProfiledInstructionsProto_Instruction* ProfiledInstructionsProto::mutable_instructions(int index) {
  // @@protoc_insertion_point(field_mutable:xla.ProfiledInstructionsProto.instructions)
  return _impl_.instructions_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::ProfiledInstructionsProto_Instruction >*
ProfiledInstructionsProto::mutable_instructions() {
  // @@protoc_insertion_point(field_mutable_list:xla.ProfiledInstructionsProto.instructions)
  return &_impl_.instructions_;
}
inline const ::xla::ProfiledInstructionsProto_Instruction& ProfiledInstructionsProto::_internal_instructions(int index) const {
  return _impl_.instructions_.Get(index);
}
inline const ::xla::ProfiledInstructionsProto_Instruction& ProfiledInstructionsProto::instructions(int index) const {
  // @@protoc_insertion_point(field_get:xla.ProfiledInstructionsProto.instructions)
  return _internal_instructions(index);
}
inline ::xla::ProfiledInstructionsProto_Instruction* ProfiledInstructionsProto::_internal_add_instructions() {
  return _impl_.instructions_.Add();
}
inline ::xla::ProfiledInstructionsProto_Instruction* ProfiledInstructionsProto::add_instructions() {
  ::xla::ProfiledInstructionsProto_Instruction* _add = _internal_add_instructions();
  // @@protoc_insertion_point(field_add:xla.ProfiledInstructionsProto.instructions)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::xla::ProfiledInstructionsProto_Instruction >&
ProfiledInstructionsProto::instructions() const {
  // @@protoc_insertion_point(field_list:xla.ProfiledInstructionsProto.instructions)
  return _impl_.instructions_;
}
